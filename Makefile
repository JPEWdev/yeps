# Builds YEP files to HTML using sphinx
...
ALLSPHINXOPTS = --builder $(BUILDER) \
                ...
                yeps $(BUILDDIR) $(SOURCES)

## html           to render YEPs to "yep-NNNN.html" files
.PHONY: html
html: venv
...
htmllive: SPHINXERRORHANDLING = --re-ignore="/\.idea/|/venv/|/numerical.rst|/yep-0000.rst|/topic/" --open-browser --delay 0 --port 55302
htmllive: _ensure-sphinx-autobuild html

## dirhtml        to render YEPs to "index.html" files within "yep-NNNN" directories
.PHONY: dirhtml
dirhtml: BUILDER = dirhtml
dirhtml: html
	mv $(BUILDDIR)/404/index.html $(BUILDDIR)/404.html

## linkcheck      to check validity of links within YEP sources
.PHONY: linkcheck
...
## test           to test the Sphinx extensions for YEPS
.PHONY: test
test: venv
